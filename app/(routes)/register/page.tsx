...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-600 to-white-100 p-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 ${
                errors.fullName ? 'border-orange-500' : 'border-gray-300'
              }`}
            />
            {errors.fullName && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onBlur={() => validateForm()}
                className={`w-full p-3 pr-12 border rounded-lg focus:ring-2 focus:ring-orange-400 ${
            ...
            <div className="relative">
              <input
                ...
                className={`w-full p-3 pr-12 border rounded-lg focus:ring-2 focus:ring-blue-400 ${
                  errors.confirmPassword ? 'border-orange-500' : 'border-gray-300'
                }`}
              />
              <span
                className="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer select-none text-gray-500 hover:text-gray-700"
